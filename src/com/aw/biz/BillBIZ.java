...
public class BillBIZ {
	...
	public boolean addBill(String uid,String gids,String gnums,String btime,String btype,String address,String db_ids){
		Bill bill=new Bill();
		bill.setUid(uid);
		bill.setGids(gids);
		bill.setGnums(gnums);
		...
		System.out.println(db_ids+"------------@@@-------------------------");
		return new GoodsDAO().deleteCartByDb_id(db_ids);
	}
